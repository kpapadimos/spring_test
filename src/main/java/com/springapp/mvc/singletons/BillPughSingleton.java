 ...
 *
 * Prior to Java 5, java memory model had a lot of issues and above approaches (ThreadSafe, Eager, Static, Lazy etc)
 * used to fail in certain scenarios where too many threads try to get the instance of the Singleton class simultaneously.
